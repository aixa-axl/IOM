 ...
 *
 * Pillar icon cards — desktop 3-col grid / mobile snap carousel.
	...
	<div class="mx-auto flex w-full max-w-site flex-col items-center <?php echo esc_attr( $outer_gap ); ?>">
		<?php if ( $has_intro ) : ?>
			<div class="flex w-full flex-col items-center gap-8 px-page xl:px-0">
				...
				<?php if ( ! empty( $tags ) ) : ?>
					<ul class="m-0 grid w-full list-none grid-cols-2 content-center items-stretch justify-center gap-4 p-0 lg:flex lg:flex-wrap lg:grid-cols-none">
		...
		<div class="flex w-full flex-col items-center gap-10">
			...
			<?php if ( ! empty( $cards ) ) : ?>
				<div class="w-full min-w-0" data-other-pillars-carousel>
					<ul
						class="m-0 flex w-full list-none gap-4 overflow-x-auto scroll-smooth px-page pb-2 [-ms-overflow-style:none] [scrollbar-width:none] snap-x snap-mandatory lg:grid lg:grid-cols-3 lg:gap-6 lg:overflow-visible xl:px-0 lg:pb-0 lg:snap-none [&::-webkit-scrollbar]:hidden"
					...
					<?php foreach ( $cards as $card ) : ?>
						...
						?>
						<li
							class="flex w-[min(100%,25rem)] shrink-0 snap-center flex-col justify-between gap-4 rounded-card border border-solid border-[#dfe8ff] bg-off-white p-6 lg:h-auto lg:w-auto lg:min-w-0 lg:snap-align-none"
