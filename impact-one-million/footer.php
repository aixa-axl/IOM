 ...
 * Figma: Impact One Million — node 606:11632
 */
...
?>
	...
	<footer id="site-footer" class="site-footer mt-auto bg-blue px-5 py-[3.75rem] text-white lg:px-gutter">
		<div class="mx-auto flex w-full max-w-site flex-col gap-12">
			<div class="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
				<div class="flex w-full max-w-[18.75rem] flex-col gap-6">
				...
				<?php if ( $has_columns ) : ?>
					<nav
						class="grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-4 lg:flex lg:gap-10"
			...
			<div class="h-px w-full bg-white" aria-hidden="true"></div>

			<div class="flex flex-col gap-4 font-sans text-[10px] font-semibold uppercase leading-none tracking-[1px] text-white sm:flex-row sm:items-center sm:justify-between">
				<p class="m-0">
